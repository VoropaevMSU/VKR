...
xor a(new_n8_, new_n6_1, new_n7_1);
xor a(new_n9_, a, b);
not b(a1, a);
not b(b1, b);
_DC a(new_n10_, a1, b1);
not b(new_n9_1, new_n9_);
not b(new_n10_1, new_n10_);
and a(new_n11_, new_n9_1, new_n10_1);
not b(c1, c);
and a(new_n12_, c1, d);
not b(d1, d);
nor a(new_n13_, c, d1);
...
xor a(new_n14_, new_n12_1, new_n13_1);
nor a(new_n15_, c, d);
not b(c1, c);
not b(d1, d);
_DC a(new_n16_, c1, d1);
...
or a(new_n19_, c1, new_n8_1);
not b(new_n18_1, new_n18_);
not b(new_n19_1, new_n19_);
_DC a(new_n20_, new_n18_1, new_n19_1);
_DC a(new_n21_, d, new_n20_);
not b(d1, d);
not b(new_n20_1, new_n20_);
and a(new_n22_, d1, new_n20_1);
not b(new_n21_1, new_n21_);
not b(new_n22_1, new_n22_);
and a(new_n23_, new_n21_1, new_n22_1);
not b(c1, c);
and a(new_n24_, c1, new_n11_);
